...
from server import app, _validate_sharepoint_url, _build_confluence_page, TEMPLATES
...
class TestGenerateRoute:
    ...
    def test_explicit_doc_name_used(self, client):
        resp = self._post(client, {"doc_url": VALID_URL, "doc_name": "My Custom Name", "template": "pov"})
        assert "My Custom Name" in resp.get_json()["markup"]
